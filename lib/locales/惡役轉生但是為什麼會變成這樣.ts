...
export const words_source: IWords[] = [
	...
	_word_jp1('ラトカ|拉特卡|拉多卡', '拉多卡'),
	//_word_jp1('エリーゼ|艾麗澤|埃麗斯', '艾麗澤'),
	_word_jp1('愛麗絲|エリーゼ', '艾麗澤'),
	 ...
	 *
	 */
	_word_jp1('希利魯|西里爾|シリル|西瑞爾|基里爾', '希利魯'),
	 ...
	 *
	 */
	_word_jp1('ユグフェナ|優格非那|尤古費納|朱格芬', '尤古芬納'),
