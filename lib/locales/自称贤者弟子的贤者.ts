...
export const words_source: IWords[] = [
	...
	['克罗斯|克雷乌斯|クレオス|克莱奥斯|克雷欧斯|雷克乌斯|克里乌斯|庫雷歐斯', '克雷烏斯'],
	['Guraia|古瑞亚', '古瑞亞'],
	['玛丽安娜|玛莉安娜|玛利安娜', '瑪麗安娜'],
	...
	_word_jp1('ラトナトラヤ', '拉特納特拉雅'),

	['(?:银|銀)之?(?:连|联)(?:塔|塔)', '銀之連塔'],

	['艾梅汝|艾梅拉|梅艾拉', '艾梅拉'],

	['法吉戴斯|弗吉迪斯|ファジーダイス|法吉迪斯|法支戴斯', '法吉戴斯'],
	['星崎昴', '星崎昴'],
	['拉斯德納達|最終騎士|ラストラーダ|拉斯德那達|拉斯特萊達', '拉斯德納達'],
	...
	['克莉斯蒂娜|克里斯蒂娜|克裏斯蒂娜|克莉絲蒂娜|克裡斯提娜|克里斯蒂那', '克莉絲蒂娜'],
	['艾丽珍娜|艾蕾珍娜', '艾蕾珍娜'],
	...
	['迦楼罗|加爾達|迦樓羅', '迦樓羅'],
	['珀伽索斯|伯珈索斯|珀加索斯', '珀伽索斯'],
	['艾泽法尔多|爱泽恩法尔德|艾泽夫鲁德|艾泽法鲁德|艾澤弗魯德', '艾澤法爾多'],
	['[緹提蒂]涅', '蒂涅'],
	...
	['波波特維茲|波波特維滋|ポポットワイズ|波波維特茲', '波波特維茲'],
	...
	_word_jp1('マリアン|尤里安', '尤里安'),
	_word_jp1('レオナ', '蕾歐娜'),

	_word_jp1('レジェンドオブアステリア', '阿斯忒瑞亞傳說'),
	_word_jp1('アステリアホーム', '阿斯忒瑞亞之家'),

	_word_jp1('グランディール', '古蘭迪爾'),

	_word_jp1('エリオ', '艾利歐'),

	_word_jp1('グリモワールカンパニー', 'Grimoire會社'),

	_word_jp1('クラフトベル', '克拉夫特貝爾'),

	_word_jp1('シルバーホーン', '希爾巴霍'),

	_word_jp1('ハクストハウゼン', '哈庫斯特海澤'),

	_word_jp1('マキナガーディアン', '機械保衛者'),

	_word_jp1('ソウルハウル', '索魯哈爾'),

	/**
	 *
	 */
	_word_jp1('エミリア|艾米利亞', '艾米莉亞'),

	_word_jp1('キメラクローゼン|基梅拉庫落', '奇美拉部落'),

	_word_jp1('エスメラルダ|艾絲美拉達|艾絲梅拉達|埃斯梅拉達', '艾絲梅拉達'),
	_word_en3('Esmeralda', '埃斯梅拉達'),

	_word_jp1('セシリア', '塞西莉亞'),

	_word_jp1('亞當斯|阿達姆斯|アダムス', '阿達姆斯'),
