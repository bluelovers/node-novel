...
export const words_source: IWords[] = [
	 ...
	 * 沃尔夫冈德
	 */
	['伏尔甘|沃尔夫|瓦爾剛|巴魯坦|巴鲁坦', '伏爾甘'],
	[`伏尔甘${sp}(?:帕瓦特|冈德)`, '伏爾甘・帕瓦特'],
	...
	['尤[利里][烏乌]斯|尤里乌斯|伊琉乌絲', '尤里烏斯'],
	['艾[璐尔]罗德|埃尔罗德|埃尔路斯|艾尔洛特|艾尔罗德|艾璐罗德|艾路羅德', '艾璐羅德'],
	...
	['西满', '西蒙'],
	['弗里德里希|弗里德希里|弗利—德里希|弗雷德里希', '弗里德里希'],
	['巴尔緹艾尔|巴尔迪亚尔|巴尔提艾尔|巴迪艾尔|巴爾迪爾|巴魯蒂埃魯', '巴爾緹艾爾'],
	...
	[/沙利葉希麗茲|沙利叶|沙利葉|萨利叶|沙利业|サリエル|薩利愛蜜|沙利葉蜜/g, '沙利叶'],
	...
	_word_jp1(`格里高利|格列高利|グレゴリウス`, '格里高利'),
	...
	_word_jp1('多魯托斯(?:坦普)?|ドルトス(?:ダンプ)?|托魯托斯|ドルトス', '多魯托斯'),
	 ...
	 *
	 */
	['巴魯巴托斯|バルバドス|巴巴多斯', '巴魯巴托斯'],
	['伊芙拉姆|イブラーム|伊夫拉姆', '伊芙拉姆'],
	...
	_word_jp1('ウル|烏露', '烏露'),
	_word_jp1('ウルスラ|烏露斯拉|烏璐斯拉', '烏露斯拉'),
	_word_jp1('蕾琪|レキ', '蕾琪'),

	_word_jp1('ランドルフ|蘭多夫|蘭鐸魯夫', '蘭鐸魯夫'),

	_word_jp1('ライアン|萊安', '萊安'),
	...
	['艾利西昂|艾利希恩|艾丽希昂|艾丽希恩|エリシオン|极乐净土|極?艾麗西昂', '艾利西昂'],
