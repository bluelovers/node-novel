...
export const words_source: IWords[] = [
	...
	['愛蜜艾璐羅德|愛蜜盧德|耶魯艾璐羅德|埃爾艾璐羅德|艾(璐|尔)罗德|埃尔罗德|埃尔路斯|艾尔洛特|艾尔罗德|艾璐罗德|艾路羅德|艾爾洛德|埃爾盧德|耶魯盧德', '艾璐羅德'],
	...
	_word_jp1('米里亞德|米利阿魯多|ミリアルド', '米利阿魯多'),
	...
	_word_jp1('マクシミリアン|瑪庫希米麗安', '瑪庫希米麗安'),
	...
	_word_jp1('アークライト|阿克萊特', '阿克萊特'),
	_word_jp1('アズラエル|阿茲拉爾', '阿茲拉爾'),
	_word_jp1('ドラクロワ|德拉克洛瓦', '德拉克洛瓦'),

	_word_jp1('塞利斯|セリス', '塞利斯'),
	_word_jp1('安|アン', '安'),

	_word_jp1('ガクラン|詰襟', '詰襟'),
	...
	['赛利亚|瑟莉雅|西利亚|菲莉亞|西莉亞|瑟利雅|賽利亞|塞莉亞', '賽莉亞'],
	...
	['詛?咒物品?(?:剑|角|角)(斗|鬥|闘)大(会|會)|詛咒武器競技大賽|呪物剣闘大會|詛咒劍闘大會|詛咒角闘大會|詛咒武器角闘大會', '詛咒物品剣闘大会'],
	...
	['ブ儿ーム|ブルーム', 'ブルーム'],
	[/(Ains|艾因茲|アインズ|ainz|艾因茨)[・\?]?(B[rl]oom|布魯姆|ブルーム|ブ儿ーム|ブ兒ーム)|愛因布魯姆|愛因・布魯姆|艾因・布魯姆|艾因布魯姆/ig, '艾因茲・布魯姆'],
