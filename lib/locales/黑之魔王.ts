...
export const words_source: IWords[] = [
	 ...
	 * 赛利亚|瑟莉雅 兰布尔
	 */
	['威爾納德|威爾(哈鲁?特|哈尔?德)|瓦爾納德|瓦尔哈尔?德', '威尔哈鲁特'],
	['威爾|瓦爾', '威尔'],
	...
	['西满', '西蒙'],
	['弗里德里希|弗里德希里|弗利—德里希', '弗里德里希'],
	['巴尔緹艾尔|巴尔迪亚尔|巴尔提艾尔|巴迪艾尔|巴爾迪爾|巴魯蒂埃魯', '巴尔緹艾尔'],
	...
	[`(完整調试|フルチュ－ン|完全調试|弗盧裘恩)[・ \?](哥雷姆|塔诺斯|タウスル|托魯斯)`, '完整調试・托魯斯'],
