...
export const words_source: IWords[] = [
	...
	_word_jp1('ガルテ|迦魯迪|迦魯德|格魯特', '迦魯迪'),
	_word_jp1('バッソ|巴索', '巴索'),

	_word_jp1('コラード|格拿特|科拉德|格納特|格蘭奧多', '科拉德'),
	 ...
	 *
	 */
	['ケンスルーナ|森斯露娜|森斯路那|肯思魯娜|森思路那', '森斯露娜'],
	 ...
	 *
	 */
	['グラウィオール|葛洛伊奧爾萊|古拉伊奧─?魯|古拉維奧爾|格拉畢歐魯', '格拉畢歐魯'],

	['アルゼンタム|魯澤恩|Aruzentamu|阿爾贊塔姆', '阿爾贊塔姆'],

	['ウォーレン|沃倫', '沃倫'],

	['オリアーナ|奧麗亞娜|奧莉安娜|奧里亞娜', '奧麗亞娜'],
