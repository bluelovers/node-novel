...
export const words_source: IWords[] = [
	...
	['澳莉嘉|奥莉佳|[奥澳][利莉丽][佳嘉加]|奥莉加|奥丽加|奧莉嘉', '奧莉佳'],
	['卡夏|卡莎|卡萨|卡沙', '卡莎'],
	...
	['[·。](托瑞尔|托莉尔|托莉艾)[·。](奥克索兰蒂|奧斯庫蘭特)', '・托莉爾・奧克索蘭蒂'],

	['伊梅娜丽亚|依梅娜利亚|依梅拉丽雅|imeraria|依梅拉丽雅|依梅拉麗雅|依拉麗雅', '依梅娜利亞'],
	['娜丽亚|娜利亚|拉丽雅', '娜利亞'],
	['公主|王女', '王女'],
	 ...
	 * 蕾菲
	 */
	['VERUDORE|维拉多尔|維魯多尼', '維拉多爾'],
	[/苏普朗格鲁\?根古\?霍兰特/g, '蘇普朗格魯・根古・霍蘭特'],
	['蘇普朗格魯|苏普朗格鲁|蘇普朗格魯', '蘇普朗格魯'],
	[/优古\?优提勒夫托/g, '優古・優提勒夫托'],
	['庫澤姆|库泽姆', '庫澤姆'],
	['霍兰特|霍根|霍特蘭|霍蘭特|霍兰德', '霍蘭特'],
	['納爾格魯|[纳納][尔爾]格[鲁魯]', '納爾格魯'],
	...
	['奥梭格兰地|奥斯库兰德|奥克索兰蒂|奥索格兰蒂|奧斯庫蘭德|奧斯庫蘭特|奧斯蘭庫德', '奧克索蘭蒂'],
	['维西|维希|维多|維西', '維希'],

	['佛卡洛尔|佛卡荣如|佛卡罗鲁|佛卡罗尔|佛卡羅爾|佛卡羅斯', '佛卡洛爾'],
	['阿羅塞魯|阿罗塞尔', '阿羅塞爾'],
