...
export const words: IWords[] = [
	...
	//哥德斯拉斯
	//莎布纳古
	sublib._word_zh('莎布納古|莎布纳古', '莎布納古'),
	 ...
	 * 洛西（ロシー）
	 */
	sublib._word_zh('米诺斯|米诺索', '米诺索'),
	sublib._word_zh('贝雷维拉|贝罗为拉|贝内维拉', '贝雷維拉'),
	 ...
	 * 赫拉（ヘラ）
	 */
	sublib._word_zh('托倫|多伦', '多伦'),

	sublib._word_zh('普鲁夫拉苏|普魯夫拉蘇', '普鲁夫拉苏'),

	['铁四指|寸铁', '寸铁'],
	sublib._word_zh('(水色)?蓝宝石|水宝石', '水色蓝宝石'),
	...
	sublib._word_zh('瑪魯法斯|玛鲁法斯|マルファス?', '玛鲁法斯'),
	['里德爾|莉黛尔', '莉黛尔'],
	...
	sublib._word_zh('沙魯古|萨路古', '萨路古'),

	['碧妮|[维維]涅|ヴィーネ', '維涅'],
	['片耳|单耳', '单耳'],
	['单耳的?兔兽人', '单耳兔兽人'],

	sublib._word_zh('兽人|獸人', '獸人'),
	 ...
	 * 阿喀什农（アガチオン）
	 */
	sublib._word_zh('(微|薇)(怕|帕)爾特?|薇帕尔特|薇帕尔|薇帕爾|ウェパル', '薇帕尔'),
	['阿喀什农|阿喀什安', '阿喀什农'],
	...
	sublib._word_zh('索德蘭特|索德兰特', '索德兰特'),

	sublib._word_zh('罗奴|羅納', '罗奴'),

	sublib._word_zh('行会|公会|协会', '公会'),
