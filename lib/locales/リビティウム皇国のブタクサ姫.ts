...
export const words_source: IWords[] = [
	...
	[`格魯拉德|コルラード|弗魯那多|科魯拉德|科魯拉德`, '格魯拉德'],
	[`コッラード|Korrado`, 'コッラード'],
	...
	_word_jp1('テラメエリタ|提拉美利亞|Terameerita', '提拉美利亞'),

	_word_jp1('阿德爾海德|アーデルハイド', '阿德爾海德'),

	_word_jp1('イライザ|伊麗莎|伊裡莎', '伊麗莎'),
	...
	_word_jp1('ラビエル|拉比露', '拉比露'),
	_word_jp1('テレーザ|特蕾莎', '特蕾莎'),

	_word_jp1('クロリンダ|黑琳達', '黑琳達'),
	...
	_word_jp1('セルメルト|公分|serumeruto', '美爾', 'ig'),
	_word_jp1('メルト|美爾|Meruto', '美爾', 'ig'),
