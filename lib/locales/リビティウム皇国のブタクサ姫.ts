...
export const words_source: IWords[] = [
	...
	_word_jp1('ドルミート|托魯米特|多爾米特', '托魯米特', 'ig'),

	_word_jp1('艾絲蒂爾|エステル', '艾絲蒂爾', 'ig'),
	_word_jp1('莉潔|リーセ', '莉潔', 'ig'),

	_word_jp1('赫雷斯|ベーレンズ', '赫雷斯', 'ig'),
