...
export const words_source: IWords[] = [
	...
	_word_jp1('阿德爾海德拉?|アーデルハイド?', '阿德爾海德'),

	_word_jp1('(伊麗莎)+|イライザ|伊麗莎|伊裡莎|伊莉莎|伊萊莎', '伊麗莎'),
	...
	['(初源的?人間)+|Dolly Qadmon|ドリーカドモン', '初源的人間', 'ig'],
