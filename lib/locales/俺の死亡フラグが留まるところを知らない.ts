...
export const words: IWords[] = sublib._word_zh_all([
	 ...
	 * 雨果・格拉夫顿
	 */
	['尤西乌斯|尤斯图斯|尤斯托斯|賈斯特斯|尤斯特斯', '尤西乌斯'],
	[`尤西乌斯${sp}(?:弗洛伊德|弗洛英多|弗洛因德|弗罗因德)`, '尤西乌斯・弗洛伊德'],

	['萨利昂?|萨里扬|撒里昂|萨里昂|萨里安|賽利安', '萨里昂'],
