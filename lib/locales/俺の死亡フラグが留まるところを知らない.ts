...
export const words_source: IWords[] = [
	 ...
	 * 文森特・范・威斯特魯弗奧魯特
	 */
	_word_jp1('科迪|寇迪|コーディー', '科迪'),
	_word_jp1('ルジアル', '盧傑亞爾'),

	[`科迪${sp}(?:罗西阿魯|魯吉阿尔|卢卡魯|盧傑亞爾|魯吉亞)`, '科迪・盧傑亞爾'],
	 ...
	 * 雨果・格拉夫顿
	 */
	['尤西乌斯|尤斯图斯|尤斯托斯|賈斯特斯|尤斯特斯', '尤斯圖斯'],
	_word_jp1('ユストゥス', '尤斯托斯'),

	[`(?:弗洛伊德|弗洛英多|弗洛因德|弗罗因德|弗洛因特)`, '弗洛因特'],
	_word_jp1('フロイント', '弗洛因特'),

	[`(?:尤西乌斯|尤斯托斯|尤斯圖斯)${sp}(?:弗洛伊德|弗洛英多|弗洛因德|弗罗因德|弗洛因特)`, '尤斯圖斯・弗洛因特'],
	...
	_word_jp1('星光?體', '星光體'),
	_word_jp1('アストラルポーション|星光藥水', '星之藥'),
	_word_jp1('アストラル', '星光'),
	_word_en3('Astral Potion', '星之藥'),
