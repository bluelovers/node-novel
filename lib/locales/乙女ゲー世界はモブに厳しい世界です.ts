...
export const words_source: IWords[] = [
	 ...
	 *
	 */
	_word_jp1('盧克希翁|魯庫爾希翁|拉克森|光子號|ルクシオン|路克西翁|路庫西翁恩?|盧克西昂|勒克西翁|盧克西恩|盧克西翁|路克西翁|勒克錫安|勒克西恩|路西翁|魯庫爾西斯|魯庫西翁|利克西翁|盧克錫翁|路克席翁|盧克因恩|魯庫爾因恩|魯克因恩|盧克希恩', '路克西翁'),
	...
	_word_jp1('クレアーレ|古蕾亞蕾(?:利|克雷)?|克蕾亞蕾(?:克雷)?', '克萊雅蕾'),
	_word_jp1('アーレ', '亞蕾'),
