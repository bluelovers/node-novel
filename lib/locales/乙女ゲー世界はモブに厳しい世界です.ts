...
export const words_source: IWords[] = [
	...
	_word_jp1('マリエ|瑪麗埃|瑪莉埃|瑪麗艾|瑪莉艾|瑪麗唉|瑪莉唉|瑪莉耶|馬裡埃|馬裡艾|馬利艾', '瑪麗艾'),
	 ...
	 *
	 */
	_word_jp1('ユリウス|尤利烏斯|朱麗葉斯', '尤里烏斯'),
	_word_jp1('ホルファート', '霍爾法特'),

	_word_jp1('ミレーヌ|米蓮艾露|米倫|米蓮|米蘭', '米蓮'),

	/**
	 *
	 */
	_word_jp1('ヘルトルーデ|赫?爾忒露蒂|貝爾托露蒂|赫爾托魯蒂|赫爾特魯蒂', '赫爾忒露蒂'),
	_word_jp1('セラ', '塞拉'),
