...
export const words: IWords[] = sublib._word_zh_all([
	...
	//ケアル
	['ケアルラ|克婭萝菈', '克婭萝菈'],
	['克亚罗加?|克罗亚加?|克亞魯加|ケアルガ|可罗亚加?|Kearuga', '克亞罗'],
	...
	['芙莉雅|美莉雅|芙莉亞|フレイア|芙利亞', '芙莉雅'],

	['アールグランデ|阿魯古兰迪', '阿魯古兰迪'],
	['クラタリッサ|庫拉塔利萨', '庫拉塔利萨'],
	['吉欧拉尔|奇欧拉魯|吉奧拉尔|ジオラル|吉奧拉魯', '吉欧拉尔'],
