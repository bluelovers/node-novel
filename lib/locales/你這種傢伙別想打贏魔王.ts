...
export const words_source: IWords[] = [
	...
	['琪莉露|キリル|琪利露|琪利露|琪莉璐', '琪莉露'],
	['斯維奇卡|スウィーチカ|絲維奇卡', '斯維奇卡'],

	['ジーン|吉恩', '吉恩'],
	['インテージ|伊恩特吉', '伊恩特吉'],

	['葉塔娜|エターナ|叶塔娜|艾塔娜|埃塔納|艾塔納', '艾塔娜'],
	['利恩巴烏|リンバウ|莉恩巴烏|林巴歐', '利恩巴烏'],
	 ...
	 *
	 */
	_word_jp1('シートゥム|西圖姆|希圖姆', '西圖姆'),
	_word_jp1('セレイド|塞雷伊德|賽雷伊德', '賽雷伊德'),
	...
	_word_jp1('インク|茵庫|因庫', '茵庫'),
		_word_jp1('利夫庫拉福特|利斯庫拉福特|里斯克拉夫特|リースクラフト', '利斯庫拉福特'),
	...
	_word_jp1('奇亞拉利|奇亚拉立|キアラリィ', '奇亞拉利'),

	_word_jp1('微笑屠殺者的大馬士革手套|微笑殺戮者的大馬士革手甲', '微笑殺戮者的大馬士革手甲'),
