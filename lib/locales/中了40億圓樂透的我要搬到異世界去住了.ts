...
export const words_source: IWords[] = [
	...
	_word_jp1('伊斯特爾|伊斯提(?:爾|魯)?|伊榭路|イステール', '伊斯提'),

	[`(?:吉珂妮亞)${sp}(?:伊斯提)`, '吉珂妮亞・伊斯提'],

	_word_jp1('マクレガー|馬庫雷伽|馬庫雷加', '馬克雷伽'),
	 ...
	 * イクシオス
	 */
	_word_jp1('シルベストリア|希爾維絲托莉亞|希爾蓓絲托莉婭|希爾貝絲托利亞|希爾貝絲托利', '希爾維絲托莉亞'),
	 ...
	 *
	 */
	_word_jp1('バルベール|巴貝爾|巴魯貝爾|巴魯貝魯|巴魯德魯|巴魯培|巴爾魯|巴爾貝爾', '巴貝爾'),
	...
	_word_jp1('ガイエルシオール|蓋耶羅西奧爾|蓋耶爾希歐爾|蓋耶爾西歐爾', '蓋耶爾希歐爾'),
	...
	_word_jp1('ウリボウ|烏利波', '烏力波'),
	_word_jp1('アルマル|阿魯瑪魯', '瑪魯瑪魯'),
