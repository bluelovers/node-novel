...
lazymarks['c050'] = _word_zh_all([
	...
	[/([…─師賴也吗么得嗎備了題色組激生来本由謊幣币麼思伙人君呵恩呣中樣噢喏个容子嘞跑聊咧話的蛤哦哎系勒毒妹誒呀萬笑者雄办喔我營恋道心帥害做個族策車蹈具哈对事破嗯辦喲嘛欸著咦船家貓到能呢來啊數阿用辈何裡忙吶吧了哟趣里做样诶谁量醬在～！？][\?!]+|[\?!]+[」…）！])/ug, function (...m)
	{
		return StrUtil.toFullWidth(m[0], {
			skip: {
				space: true,
