...
lazymarks['c050'] = _word_zh_all([
	...
	[/([…─師賴也額吗么近是得嗎處備了題色組激生来本由謊幣币麼思伙人君呵恩呣中樣噢喏个容子嘞跑聊咧話的蛤哦技哎喵狂熱要系勒毒妹誒呀萬笑者雄办喔我營恋道心帥變會則女害做個族策車蹈具哈对事破嗯辦喲嘛欸著咦船家貓到能呢來啊數阿用辈何裡忙好場吶加裏吧了哟趣里做样诶谁量見醬在～！？][\?!]+|[\?!]+[」…）！])/ug, function (...m)
	{
		return StrUtil.toFullWidth(m[0], {
			skip: {
				space: true,
...
lazymarks['c100'] = _word_zh_all([
	...
	[/^[ ]*([─＝═=══－\-─—\*＊＊◇◆☆◊▃\.…\.─]+)(?:這?是?作者的?分隔線|我?是?分(?:隔|割)线|以下正文|华丽+分割线|分割|華麗+分割線|作者自加的分割線)+([──＝═=══－\-─—\*＊＊◇◆☆◊▃…\.]+)[ ]*$/gm, '$1$2'],
