...
lazymarks['c050'] = _word_zh_all([
	...
	[
		/([…⋯─師賴法也額吗么近錢只是得嗎處備了題色組激生来本由謊幣币麼思伙人君呵恩呣中嗯樣噢喏个容子嘞跑聊咧話的蛤哦技哎掉喵狂熱要地系勒毒妹誒暑呀萬笑者雄办喔我營恋道心帥變會則女害做個族策車號吧桑後兒王啦拉蹈具哈对事破嗯辦喲襲嘛欸著咦船家留貓到能呢來啊冊數阿用喬辈何誰國裡忙好場吶加裏吧了哟趣里做样前桶诶谁物量見醬在係～！？][\?!]+|[\?!]+[」…⋯）！])/ug,
		function (...m)
		{
			return StrUtil.toFullWidth(m[0], {
				skip: {
