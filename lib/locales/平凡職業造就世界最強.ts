...
export const words_source: IWords[] = [
	 ...
	 */
	_word_jp1('ユエ', '月'),
	_word_jp1('ディンリード|丁德里|丁里德', '丁里德'),

	/**
	 *
	 */
	_word_jp1('奧爾克斯|奧爾庫司|オルクス', '奧爾庫司'),
	_word_jp1('哈魯森納|哈魯茲納|哈爾崔那|ハルツィナ', '哈爾崔那'),
	 ...
	 *
	 */
	_word_jp1('提奧|提歐|緹鷗|緹奧|ティオ|緹歐', '緹奧'),
	...
	_word_jp1('拉娜|ラナ', '拉娜'),
	_word_jp1('拉娜英菲莉娜|拉娜因費麗娜', '拉娜英菲莉娜'),
	 ...
	 *
	 */
	_word_jp1('アビスゲート卿?|阿庇斯凱特卿?|深淵卿卿?|深淵先生|深淵之門卿', '深淵卿'),
	...
	_word_jp1('グラント|格蘭特|古蘭特', '格蘭特'),

	_word_jp1('卡魯|カール', '卡魯'),

	_word_jp1('凡妮莎|ヴァネッサ|帆妮莎', '凡妮莎'),
	_word_jp1('帕拉蒂|パラディ|巴拉蒂', '帕拉蒂'),
	...
	_word_jp1('夏洛|シャロン', '夏洛'),
	_word_jp1('瑪古達勒斯|マグダネス|馬格達妮斯|馬達格斯|瑪古達尼斯', '瑪古達勒斯'),
	...
	_word_jp1('トリアイナ|托利安那|多利安納', '托利安那'),
	[`潜水艇`, `潛水艇`],
