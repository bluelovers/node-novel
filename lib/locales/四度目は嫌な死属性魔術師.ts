...
export const words: IWords[] = sublib._word_zh_all([
	 ...
	 *
	 */
	['[羅罗]多(可[爾尔]特|特[鲁魯]特)|羅多可爾特|罗多可尔特|罗德科尔特|罗德科尔德|罗德科尔司', '罗多特魯特'],
	['阿[尔爾]达|阿魯達|阿納达|阿[纳納][达達]|アルダ|阿达尔', '阿尔达'],

	[`邪神${sp}巴魯魯夏培`, '邪神・巴魯魯夏培'],

	//魔王古杜兰斯
	['古督拉尼斯|古杜兰斯|古敦拉尼斯|グドゥラニス|格德拉尼斯|格拉尼斯|尼古拉尼斯', '古杜兰斯'],
	...
	['扎纳[爾尔]帕多娜|劄納[爾尔]帕多娜|札納魯帕多那|扎纳[爾尔]帕多娜|扎纳爾帕多娜|帕爾帕多娜|札納魯帕多納|ザナルパドナ|萨納帕多納|扎克巴德納|扎克斯|扎納爾巴多納|帕尔萨克斯', '扎納爾帕多娜'],
	['扎纳尔', '扎納爾'],
	['帕多那', '帕多娜'],
