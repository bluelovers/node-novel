...
export const words: IWords[] = sublib._word_zh_all([
	...
	['[巴帕][絲斯絲丝][緹提蒂蒂][亞亚雅]|巴斯提雅|巴斯迪亞|巴士蒂亞', '巴斯蒂亞'],
	['[维維维][格賈贾][罗羅]|彼伽洛|彼伽罗|彼伽羅|維卡洛|維加羅', '維格羅'],
	 ...
	 */
	['[拉菈][批比彼][艾伊][薩萨莎][裘舒久]?|拉彼伊萨久|菈比艾薩裘|ラピエサージュ|拉披艾薩久', '菈比艾薩裘'],
	...
	['傑赫納蜜蜂|格赫納蜂蜜蜂|ゲヘナビー|傑赫納蜜?蜂|格赫納蜜?蜂|傑赫納蜜?蜂|傑赫納比?|格拉娜比', '格赫納蜂'],
	...
	// 肉块
	['雷吉欧|雷奇奧|雷吉安|レギオン|雷里欧|雷吉恩|欧吉恩|蕾吉歐', '雷吉歐'],
	 ...
	 * ズラン_(巨人族斥侯轉忍者_殭屍) 茲蘭
	 */
	['波庫斯|博克斯|沃[尔爾]克斯|奥克斯|ボークス|博古斯', '沃爾克斯'],
	...
	// @todo 人
	['[路鲁魯][切其奇][里里][亞亚][诺諾]|路切里阿久|路西里亚诺|路奇利亞多|ルチリアーノ|魯奇阿諾|魯奇亞諾|魯奇里阿諾|魯奇阿里諾|魯奇裡亞諾', '魯奇里亞諾'],
	...
	['ゾッド|澤多|索德|佐德', '佐德'],
	['澤爾哥多里昂|ゾルコドリオ|索尔科多里奧|佐爾哥迪奧', '澤爾哥多里昂'],
	 ...
	 *
	 */
	['[羅罗]多(可[爾尔]特|特[鲁魯]特)|羅多可爾特|罗多可尔特|罗德科尔特|罗德科尔德|罗德科尔司|羅多刻魯特', '羅多特魯特'],
	...
	['愛と生命の女神|愛與生命的女神|生命與愛的女神', '愛與生命的女神'],

	['維達的睡所|ヴィダの寝所|維達之睡所|維達的寢所', '維達的寢所'],
	...
	['理刻[連连]多|利[庫库]伦|リクレント|利庫轮|利庫連多', '理刻連多'],
	//创造和空间之神
	...
	['(寨卡特|ザッカート)の試練|寨卡特的?考验|寨卡特的試錬', '寨卡特的試練'],
	...
	['冯|馮|フォン', '馮'],
	['[貝贝]武多|[貝贝][爾尔][烏乌]德|貝爾烏多|貝爾烏托|威伍德|ベルウッド|贝舞多|貝武夫|佩德木|伯德木|貝爾伍德', '貝武多'],
	...
	['拉波比法(多|特|德)?|拉伯彼法多|拉波彼法多|拉多彼法多|拉波比法特|拉波比法德|ラヴォヴィファード|拉沃维德|拉沃比法多|拉布比法多|拉沃彼法多', '拉波彼法多'],

	['姆布布姜戈|慕噗噗傑戈|姆布布杰戈|姆布布傑戈|穆噗噗简格|ムブブジェンゲ|穆璐璐简格|穆布布斯(基德)?|姆布布简戈', '姆布布姜戈'],
	...
	[`威尔迪哥|ウェンディゴ|威伦迪哥`, '威尔迪哥'],
	[`铁城威尔迪哥|ポイズンウェンディゴ|劇毒威尔迪哥|ポイズン威尔迪哥|铁城韦迪哥`, '劇毒威尔迪哥'],
	...
	//['精靈', '精灵'],
	['(暗黑|黑暗|闇|暗)(精[灵靈]|艾尔芙)|(黑?暗|暗?黑|黑暗|闇)精靈', '暗黑艾爾芙'],
	['(混血|半)精[灵靈]', '$1艾爾芙'],
	...
	['(?:ジュンペイ|朱烈拉)・(?:ムラカミ|穆拉卡米)', '朱烈拉・穆拉卡米'],

	['ベルセルク|依佐娜美|佐佐娜美', '依佐娜美'],
