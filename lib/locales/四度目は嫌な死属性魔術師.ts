...
export const words = [
	 ...
	 * #42
	 *
	 * パウヴィナ (活死人偽轉生_高貴豬頭人混血) 帕烏維納 帕碧娜 法奥碧娜 女
	 */
	['布拉卡|布拉格', '布拉格'],

	['[嘉佳伽伽][妲妲達达达][露爾尔尔]', '嘉妲露'],

	['帕(碧|[烏乌][維维])[娜納奈娜娜那]|法[奥奧]碧[娜納奈娜娜那]|帕[烏乌]维[娜納奈娜娜那]', '帕碧娜'],
	...
	//米爾古盾國
	['(?:米爾|米[鲁魯])[古固]盾[国國]', '米魯固盾国'],

	/**
	 * 巴恩蓋亞大陸南部
	 */
	['邦盖亚|[巴伯]恩[蓋盖][亞亚]|柏凱恩', '巴恩蓋亞'],
	...
	['冯|馮', '馮'],
	['[貝贝]武多|[貝贝][爾尔][烏乌]德', '貝武多'],
	['馬修庫札爾|玛修克札[鲁魯]|玛仕库扎[尔爾]|玛修克札[鲁魯]', '馬修庫札爾'],
...
export const words_maybe = [
	...
	/(.{1,2})?(不死(?!者|巨人|骷髏|沃[尔爾]克斯|小虫|化|骷髅|虫|树魔|性))(.{1,2})?/g,
	'亞斯',
