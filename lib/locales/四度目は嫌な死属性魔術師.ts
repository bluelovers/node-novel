...
export const words: IWords[] = sublib._word_zh_all([
	...
	['阿[尔爾]达|阿魯達|阿納达|阿[纳納][达達]|アルダ', '阿尔达'],
	['非非流修咯咯', '西里酥卡卡'],
	...
	//哈托納公爵領
	['哈[德托][纳納]|哈多那|哈多那|哈托納|哈托拉|哈特納', '哈托納'],
	 ...
	 * 巴恩蓋亞大陸南部
	 */
	['邦盖[亞亚]|[巴伯]恩[蓋盖][亞亚]|柏凱恩|巴恩加亞', '巴恩蓋亞'],
	...
	['マシュクザール|馬修庫札爾|玛修克札[鲁魯]|玛仕库扎[尔爾]|玛修克札[鲁魯]|馬修庫紮魯|馬其克萨尔', '馬修庫札爾'],
	...
	['姆布布姜戈|慕噗噗傑戈|姆布布杰戈|姆布布傑戈|穆噗噗简格|ムブブジェンゲ|穆璐璐简格', '姆布布姜戈'],
	 ...
	 *
	 **/
	['库内莉[亞亚]|庫涅莉[亞亚]|柯涅莉婭|庫内利亞|庫塔利亞|クーネリア|庫内亞', '庫涅莉亞'],
	['吉劄尼亞|吉札尼亞|吉札尼[亞亚]|吉萨亞|吉薩尼婭|ギザニア|基萨尼亞', '吉札尼亞'],

	['扎纳[爾尔]帕多娜|劄納[爾尔]帕多娜|札納魯帕多那|扎纳[爾尔]帕多娜|扎纳爾帕多娜|帕爾帕多娜|札納魯帕多納|ザナルパドナ|萨納帕多納', '扎納爾帕多娜'],
	['扎纳尔', '扎納爾'],
	['帕多那', '帕多娜'],
