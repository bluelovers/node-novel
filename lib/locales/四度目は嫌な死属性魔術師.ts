...
export const words_source: IWords[] = [
	...
	[/(範|范|班|泛)(?:達?(爾|魯|貝)|(貝|達)(爾|魯)?)|班達爾|ヴァンダルー|小提琴|班達魯|班詳魯/g, '班達魯'],
	...
	// @todo 女僕
	_word_jp1('(沙|莎|薩)(利|莉)(娅|雅|亞)|萨里亚|沙利婭|サリア|莎莉亞|薩利婭', '沙利婭'),
	_word_jp1('(麗|利|莉)(塔|薩)|リタ', '麗塔'),
	_word_jp1('薩姆|サム|山姆', '薩姆'),

	// @todo 食屍鬼/古尔
	['薩(緹|蒂|提|缇)莉(絲|斯)|萨蒂亚斯|ザディリス|萨迪斯|蕯蒂利斯|萨蒂利斯|萨蒂利亞|札蒂莉絲', '薩蒂莉斯'],
	['(巴|帕)(絲|斯)(緹|提|蒂)(亞|雅)|巴斯提雅|巴斯迪亞|巴士蒂亞|バスディア|帕斯蒂安|巴絲迪亞', '巴斯蒂亞'],
	['維(格|賈|贾)羅|彼伽洛|彼伽罗|彼伽羅|維卡洛|維加羅|ヴィガロ|維嘉羅', '維格羅'],

	_word_jp1('(塔|达|塔)(利|蕾|雷|莉)亞|塔利亞|タレア|塔利婭|塔蕾亞', '塔利亞'),
	...
	['帕(?:碧|(?:烏|乌)維)(娜|納|奈|娜|娜|那)|法奧碧(?:娜|納|奈|娜|娜|那)|帕(?:烏|乌)维(?:娜|納|奈|娜|娜|那)|帕烏維納|哈帕碧|パウヴィナ|帕烏薇娜|帕奥碧娜', '帕碧娜'],
	 ...
	 */
	['(?:拉|菈)(?:批|比|彼)(?:艾|伊)(?:薩|萨|莎)(?:裘|舒|久)?|拉彼伊萨久|菈比艾薩裘|ラピエサージュ|拉披艾薩久|菈比艾莎舒|菈琵艾莎鳩', '菈比艾薩裘'],
	 ...
	 * 不死树魔
	 */
	['艾赞|艾善|蓝染|爱赞|艾珍|艾森|艾善', '艾贊'],

	_word_jp1('アイゼン', '艾贊'),

	// 史萊姆
	_word_jp1('奇尤魯|可爾|庫魯|キュール|逑鲁|裘路', '可爾'),

	// 肉块
	['雷吉欧|雷奇奧|雷吉安|レギオン|雷里欧|雷吉恩|欧吉恩|蕾吉歐|萊吉恩|雷吉翁', '雷吉歐'],
	...
	_word_jp1('(蕾|雷)(比|碧)(亞|雅)|利维亞|利維亞|蕾比雅|レビア|雷維亞|蕾碧亞', '蕾比雅'),
	['第一王女|大公主', '第一王女'],

	['小小的天才|小小天才|小さき天才', '小小天才'],

	['ザンディア|桑提赞亞|(萨|莎)(提|蒂)亞|桑提亞|赞蒂亚|莎蒂亞|蕯蒂亞|薩蒂亞|贊蒂亞', '莎蒂亞'],
	...
	['(爱|愛|艾)蓮', '愛蓮'],
	['愛莲奧諾拉?|エレオノーラ|愛蜜奧諾拉|艾蕾奧諾菈', '愛蓮奧諾拉'],
	...
	['阿爾达|阿魯達|阿納达|阿納達|アルダ|阿达尔|亞魯達', '阿爾達'],

	[`邪神${sp}巴魯魯夏培`, '邪神・巴魯魯夏培'],

	//魔王古杜兰斯
	['古督拉尼斯|古杜兰斯|古敦拉尼斯|グドゥラニス|格德拉尼斯|格拉尼斯|尼古拉尼斯|古杜蘭尼斯|古杜拉尼斯', '古杜蘭斯'],
...
_word_jp1('維(妲|达|塔|達)|維達|ヴィダ', '維達'),
	...
	['維達的睡所|ヴィダの寝所|維達之睡所|維達的寢所|維達的卧室|維達の寢所|維達的寢室', '維達的寢所'],
	...
	_word_jp1('ボティン|博坦|博蒂|博汀|博提|波婷', '博坦'),
	// 水と知識の女神
	_word_jp1('ペリア|佩利亞|沛莉雅|比利亞', '沛莉雅'),
	...
	//时间和法术之神
	['時と術の魔神|时與術之魔?神|时間與術式?の魔神|時間與術的魔神|時和術的魔神', '時與術之魔神'],

	['理刻連多|利庫伦|リクレント|利庫轮|利庫連多|利庫论|里庫連特', '理刻連多'],
	//创造和空间之神

	['创造和空间之神|空間與創造之神|空間と創造の神', '空間與創造之神'],
	...
	_word_jp1('アイスエイジ|冰神槍|冰河時期', '冰神槍'),
	_word_en3('ICE AGE', '冰神槍'),
	...
	['希爾維洛|ヒルウィロウ|希尔維罗|席尔維尔罗|希爾維羅烏', '希爾維洛'],
	 ...
	 */
	//米爾古盾國
	['(?:米爾|米鲁)(古|固)盾国|米魯庫盾国|米尔格盾国|ミルグ盾国', '米魯固盾国'],
	...
	['庫歐克|克里科斯|クオーコ|克理科斯|克里夫斯|庫奧克', '克里科斯'],
	 ...
	 */
	//哈托納公爵領
	['哈(德|托)納|哈多那|哈多那|哈托納|哈托拉|哈特納|ハートナー|哈德那|哈透納', '哈托納'],
	 ...
	 */
	// 選王國
	['歐爾巴烏姆|欧鲍姆|奥卢邦|奧尔巴|オルバウム|奧邦盧|歐魯巴烏姆', '奧盧邦'],
	['選王国', '選王国'],
	...
	['貝武多|貝爾烏德|貝爾烏多|貝爾烏托|威伍德|ベルウッド|贝舞多|貝武夫|佩德木|伯德木|貝爾伍德|貝爾德', '貝武多'],
	['マシュクザール|馬修庫札爾|玛修克札鲁|玛仕库扎爾|玛修克札鲁|馬修庫紮魯|馬其克萨尔|馬其萨尔|馬其施扎尔|馬其克塞尔|瑪仕庫紮爾', '馬修庫札爾'],
	...
	[`エルヴィーン|愛蜜維恩|愛爾維恩|艾露比恩`, '愛爾維恩'],
	[`五头蛇|五頭蛇`, '五頭蛇'],

	_word_jp1(`リッキー|裡奇`, '里奇'),
	[`里奇坊|リッキー坊|里奇小子|リッキー小鬼`, '里奇小子'],

	[`ベベケット|貝貝卡尔|貝貝卡特`, '貝貝卡特'],
	[`スレイガー|斯萊格|斯雷格|雷斯卡`, '斯萊格'],
	...
	_word_jp1(`ヨンド|影島`, '影島'),
	_word_jp1(`マイン|馬恩`, '馬恩'),
	_word_jp1(`アンディ|安迪`, '安迪'),

	[`兵之神|兵の神`, '兵之神'],
	_word_jp1(`ザレス|札雷斯`, '札雷斯'),

	[`鉄の国`, '鉄之国'],
	_word_jp1(`マルムーク`, '馬穆魯克'),
	...
	['奧爾(比|莉)(雅|亞|亚|娅)|奥莉薇(雅|亞|亚|娅)|奧利維亞|奥尔维亚|オルビア|奧魯比雅|歐露畢亞', '奧爾比雅'],
	...
	_word_jp1('奧迪华克|オニワカ|奧迪华卡|歐尼瓦卡|奧爾華卡|歐妮娃卡', '歐尼瓦卡'),
	_word_jp1('优瑪|ユーマ', '优瑪'),
	...
	_word_jp1('ブラバティーユ|布拉巴提悠', '布拉巴提悠'),

	_word_jp1('セルジオ|瑟爾吉歐', '瑟爾吉歐'),

	_word_jp1('ラルメイア|拉魯梅伊亞', '拉魯梅伊亞'),


	_word_jp1('たっぷりサンドイッチ|夠分量三明治|充足三明治', '夠分量三明治'),
	_word_jp1('サンディ|珊蒂', '珊蒂'),


	_word_jp1('バルディリア|芭露迪莉亞', '芭露迪莉亞'),

	_word_jp1('レッドゴーダ|雷德哥達', '雷德哥達'),

	_word_jp1('ミッチェム|米婕姆', '米婕姆'),

	_word_jp1('トム|托姆', '托姆'),
	_word_jp1('甘々甘味スイーツ|甜蜜蜜甜味甜點', '甜蜜蜜甜味甜點'),

	_word_jp1('シング|辛谷', '辛谷'),
	_word_jp1('パーパラス|琶帕拉斯', '琶帕拉斯'),

	_word_jp1('ウルゲン|烏魯肯', '烏魯肯'),
	_word_jp1('テルカタニス|提爾卡塔尼斯', '提爾卡塔尼斯'),

	/**
	 *
	 */
	_word_jp1('ダローク|德羅克', '德羅克'),
	_word_jp1('チプラス|捷普拉斯', '捷普拉斯'),
	...
	['バーバヤガー|巴巴亞卡|芭芭亞卡|巴巴卡亞|班巴亞伽|芭芭雅嘎', '芭芭亞卡'],

	['プルートー|布魯托|普魯托|普魯特|普路托', '布魯托'],

	['謝德|シェイド', '謝德'],

	['イザナミ|依佐娜美|(?:佐佐|(?:伊|依)(?:邪|佐))(?:娜|那)美|伊邪那美', '伊邪那美'],
	['ベルセルク|貝尔賽尔克|貝爾賽魯克', '貝爾賽爾克'],
	...
	[`梅麗莎${sp}(?:J|Ｊ)${sp}早乙女`, '梅麗莎・J・早乙女'],
	[`梅麗莎`, '梅麗莎'],

	_word_jp1('メリッサ|梅莉薩|梅麗莎', '梅麗莎'),
	_word_jp1('サオトメ|早乙女', '早乙女'),


	['土屋', '土屋'],
	['加奈子|卡娜可', '加奈子'],

	_word_jp1('カナコ|加奈子', '加奈子'),
	_word_jp1('ツチヤ|土屋', '土屋'),
	...
	['墨田城', '墨田城'],
	_word_jp1('ドルイド|德魯伊', '德魯伊'),

	_word_jp1('ジョゼフ|約瑟夫', '約瑟夫'),
	_word_jp1('スミス|史密斯', '史密斯'),

	_word_jp1('バンダー|邦達', '邦達'),

	_word_jp1('マギサ|瑪奇莎', '瑪奇莎'),

	_word_jp1('瑟莉絲|セリス', '瑟莉絲'),

	_word_jp1('ベストラ|貝絲特菈', '貝絲特菈'),
	 ...
	 * @todo Bravers
	 */
	[/Bravers|布萊巴斯|百人众|ブレイバーズ|格雷巴斯|布雷瓦斯|百勇團/ig, 'Bravers'],
	[/《(布雷伯斯|勇者們)》/ig, '《Bravers》'],
	...
	['ユニークスキル|独特技能|特殊技能', '獨特技能'],

	[/(\n・?)独特的?技能/g, '$1獨特技能'],

	[/^((?:独特|主动|被动)技能)$/gm, '・$1', 'mg'],

	_word_jp1('テロリスト|恐怖份子', '恐怖份子'),
	...
	['経験値自力取得不能|不能自力获取经验值|无法由自身获得经验值|無法自行取得經驗值|不能自力取得经验值|经验值不能自行取得|经验值不能自力获得|経験値自力取得不能|無力自行獲得經驗值', '無法自行取得經驗值'],
	...
	[`撒旦鮮血擬態史萊姆|セイタンブラッドミミックスライム`, '撒旦鮮血擬態史萊姆'],
	...
	['憑靈女僕鎧甲|リビングメイドアーマー|生活女僕鎧甲', '憑靈女僕鎧甲'],
	['リビングアーマー|憑靈鎧甲', '憑靈鎧甲'],
