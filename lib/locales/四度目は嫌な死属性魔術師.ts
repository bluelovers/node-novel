...
export const words: IWords[] = sublib._word_zh_all([
	...
	['赞塔庫|詹達庫|赞塔克|桑塔克|ザンターク|桑德克|扎德克|扎塔克|扎克塔|贊塔克', '詹達庫'],
	['堕ちた戦神|堕落的战神', '堕落的战神'],
	...
	['[薩萨]卡特|寨卡特?|寨卡特|劄坎托|扎卡特|ザッカート', '寨卡特'],
	['米[亥海][尔爾]|米海耶爾', '米亥爾'],
	['奈洛特|奈茵絡德', '奈茵絡德'],
	...
	['冯|馮|フォン', '馮'],
	['[貝贝]武多|[貝贝][爾尔][烏乌]德|貝爾烏多|貝爾烏托|威伍德|ベルウッド|贝舞多|貝武夫|佩德木|伯德木', '貝武多'],
	...
	// 聖剣ネメシスベル
	['ネメシスベル|尼科斯貝尔|尼維斯貝尔|内梅西斯貝尔', '尼科斯貝尔'],
