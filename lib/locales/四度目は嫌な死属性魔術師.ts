...
export const words_source: IWords[] = [
	...
	[/(範|范|班|泛)(?:達?(爾|魯|貝)|(貝|達)(爾|魯)?)|班達爾|ヴァンダルー|小提琴/g, '班達魯'],
	[/[範范班泛班](大人|身邊|君)/g, '班$1'],
	[/([，。！、【一])[範范班泛班]([一，。！、])/g, '$1班$2'],
	...
	// @todo 女僕
	['(沙|莎|薩)(利|莉)(娅|雅|亞)|萨里亚|沙利婭|サリア', '沙利婭'],
	['(麗|利|莉)(塔|薩)', '麗塔'],
	['薩姆|サム', '薩姆'],
	...
	['維(格|賈|贾)羅|彼伽洛|彼伽罗|彼伽羅|維卡洛|維加羅|ヴィガロ', '維格羅'],
	...
	['(蕾|雷)(比|碧)(亞|雅)|利维亞|利維亞|蕾比雅|レビア|雷維亞', '蕾比雅'],
	['第一王女|大公主', '第一王女'],
	...
	['ズラン|(茲|兹)楠|(茲|兹)蘭|兹楠|祖伦', '祖倫'],

	// @todo 人
	['(路|鲁)(切|其|奇)里亞諾|路切里阿久|路西里亚诺|路奇利亞多|ルチリアーノ|魯奇阿諾|魯奇亞諾|魯奇里阿諾|魯奇阿里諾|魯奇裡亞諾|魯奇利亞諾', '魯奇里亞諾'],
	 ...
	 *
	 */
	['羅多(可爾特|特鲁特)|羅多可爾特|罗多可尔特|罗德科尔特|罗德科尔德|罗德科尔司|羅多刻魯特|羅德科特|羅德克魯特|羅克特魯特|羅德克魯特|ロドコルテ|羅德哥爾特|羅德葛爾特', '羅多刻魯特'],
	...
	['既存ジョブ不能|不能取得已有職業|既存職業不能取得|无法就职已存在的職業|现有職業不能|無法就職已存在職業|不能就职既有職業|既存職業不能|無法就職已存在職業取得|無法就職已存在職業取得', '無法就職已存在職業|既存職業不能'],
