...
export const words: IWords[] = sublib._word_zh_all([
	...
	['赞塔庫|詹達庫|赞塔克|桑塔克|ザンターク|桑德克|扎德克', '詹達庫'],
	['堕ちた戦神|堕落的战神', '堕落的战神'],
	...
	['泽露库斯|泽尔克斯|扎塔克|ゼルクス', '泽露库斯'],

	['狩猎之神|狩?猟の神', '狩猎之神'],
	['リシャーレ|里夏丽|利纱尔|里的裡夏丽|裡夏丽|利沙雷', '利纱尔'],
	...
	['梅雷彼[贝貝][爾尔]|梅烈[贝貝]伊尔|梅雷佩[贝貝][爾尔]|梅勒貝貝[鲁魯]|梅勒貝貝依爾|メレベベイル|梅里維尔', '梅烈貝伊爾'],
