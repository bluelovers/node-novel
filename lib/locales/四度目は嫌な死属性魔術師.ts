...
export const words: IWords[] = sublib._word_zh_all([
	...
	//魔王古杜兰斯
	['古督拉尼斯|古杜兰斯|古敦拉尼斯|グドゥラニス|格德拉尼斯', '古杜兰斯'],
	...
	['法卯|ファーマウン|法馬斯', '法卯'],
	['戈尔德|ゴルド', '戈尔德'],
	[`(?:法卯|ファーマウン|法馬斯)${sp}(?:戈尔德|ゴルド|哥德)`, '法卯・戈尔德'],
	 ...
	 * 暴邪龍神・魯維茲馮爾
	 */
	['弗迪[尔爾]克|菲提魯古|菲的卢戈|菲迪魯克|フィディルグ|菲尔格', '菲迪魯克'],
	...
	[/解放的姬騎士|解放之姬騎士|解放の?姫騎士/ig, '解放の姫騎士'],
	...
	['冯|馮|フォン', '馮'],
	['[貝贝]武多|[貝贝][爾尔][烏乌]德|貝爾烏多|貝爾烏托|威伍德|ベルウッド|贝舞多|貝武夫', '貝武多'],
	...
	['姆布布姜戈|慕噗噗傑戈|姆布布杰戈|姆布布傑戈|穆噗噗简格|ムブブジェンゲ|穆璐璐简格|穆布布斯', '姆布布姜戈'],
	['墮肥的惡神|堕肥悪神|堕肥的邪神', '堕肥の悪神'],

	['布奇塔斯|ブギータス|布吉斯塔|布吉塔斯|布基尼达', '布奇塔斯'],
	 ...
	 */
	['古尔|食尸鬼|食人鬼', '食尸鬼'],
	['佐佐岡提|佐佐冈提|ゾゾガンテ|佐佐甘特|索索格德', '佐佐冈提'],
	...
	['梅雷彼[贝貝][爾尔]|梅烈[贝貝]伊尔|梅雷佩[贝貝][爾尔]|梅勒貝貝[鲁魯]|梅勒貝貝依爾|メレベベイル', '梅烈貝伊爾'],
