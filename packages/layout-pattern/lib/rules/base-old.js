...
exports.words_layout = [
    ...
    //['奴隶|奴隷', '奴隷'],
    ['圌', ''],
    ...pattern_1.default['replace_001'],
    ...pattern_1.default['jp1'],
    [/，([”』」])/g, '$1'],
    [/(.)（·）(.)/g, '$1$2'],
    ...pattern_1.default['c050'],
    [/\n[ ]*([^：\n【】]+：[^\n【】]*)\n{2,}([ ]*[^：\n【】]+：[^\n]{0,60}(?=\n|$))/ugm, '\n$1\n$2'],
    [/\n[ ]*([^：\n]+：[^\n]*)\n{2,}([ ]*[^：\n]+\n)/ug, '\n$1\n\n$2'],
    ...pattern_1.default['clear_001'],
    ...pattern_1.default['c100'],
    ...pattern_1.default['ln'],
];
/**
 * 實際使用的取代樣式
 */
...
//# sourceMappingURL=base-old.js.map